...
our %config = (
  AR => "ar",
  ARFLAGS => [ "r" ],
  CC => "/homes/zfengah/bin/gcc",
  CFLAGS => [ "-Wall -O3" ],
  CPPDEFINES => [  ],
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CXX => "/homes/zfengah/bin/g++",
  CXXFLAGS => [ "-Wall -O3" ],
  HASHBANGPERL => "/usr/bin/env perl",
  LDFLAGS => [  ],
  LDLIBS => [  ],
  PERL => "/usr/local/GNU/perl-5.22.0/bin/perl",
  RANLIB => "ranlib",
  RC => "windres",
  afalgeng => "",
  b32 => "0",
  ...
  includes => [  ],
  lflags => [  ],
  lib_defines => [ "OPENSSL_PIC", "OPENSSL_CPUID_OBJ", "OPENSSL_IA32_SSE2", "OPENSSL_BN_ASM_MONT", "OPENSSL_BN_ASM_MONT5", "OPENSSL_BN_ASM_GF2m", "SHA1_ASM", "SHA256_ASM", "SHA512_ASM", "KECCAK1600_ASM", "RC4_ASM", "MD5_ASM", "AES_ASM", "VPAES_ASM", "BSAES_ASM", "GHASH_ASM", "ECP_NISTZ256_ASM", "ECP_SM2Z256_ASM", "X25519_ASM", "PADLOCK_ASM", "POLY1305_ASM" ],
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)/homes/zfengah/bin/gcc",
  minor => "1.1",
  ...
  perl_cmd => "/usr/local/GNU/perl-5.22.0/bin/perl",
  perl_version => "5.22.0",
...
our %target = (
  ...
  cxxflags => "-std=c++11 -pthread -m64 -fopenmp",
  defines => [  ],
  ...
  dso_extension => ".so",
  dso_scheme => "dlfcn",
  ec_asm_src => "ecp_nistz256.c ecp_nistz256-x86_64.s x25519-x86_64.s ecp_sm2z256.c ecp_sm2z256-x86_64.s",
  ec_obj => "ecp_nistz256.o ecp_nistz256-x86_64.o x25519-x86_64.o ecp_sm2z256.o ecp_sm2z256-x86_64.o",
  enable => [ "afalgeng" ],
  ex_libs => "-ldl -pthread -fopenmp",
  exe_extension => "",
  includes => [  ],
...
our %unified_info = (
            ...
            "crypto/ec" =>
                {
                    "deps" =>
                        [
                            ...
                            "crypto/ec/ecp_oct.o",
                            "crypto/ec/ecp_sm2z256-x86_64.o",
                            "crypto/ec/ecp_sm2z256.o",
    ...
    "rawlines" =>
        [
            ...
            "	CC=\"\$(CC)\" \$(PERL) \$< \$(PERLASM_SCHEME) \$\@",
            "crypto/ec/ecp_sm2z256-%.S:	crypto/ec/asm/ecp_sm2z256-%.pl",
            "	CC=\"\$(CC)\" \$(PERL) \$< \$(PERLASM_SCHEME) \$\@",
        ],
    "rename" =>
        {
