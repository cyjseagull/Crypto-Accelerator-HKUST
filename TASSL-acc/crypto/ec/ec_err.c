...
static const ERR_STRING_DATA EC_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_ECP_SM2Z256_GET_AFFINE, 0),
     "ecp_sm2z256_get_affine"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECP_SM2Z256_INV_MOD_ORD, 0),
     "ecp_sm2z256_inv_mod_ord"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECP_SM2Z256_MULT_PRECOMPUTE, 0),
     "ecp_sm2z256_mult_precompute"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECP_SM2Z256_POINTS_MUL, 0),
     "ecp_sm2z256_points_mul"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECP_SM2Z256_PRE_COMP_NEW, 0),
     "ecp_sm2z256_pre_comp_new"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECP_SM2Z256_WINDOWED_MUL, 0),
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_PKEY_EC_SM2DH_DERIVE, 0),
     "pkey_ec_sm2dh_derive"},
